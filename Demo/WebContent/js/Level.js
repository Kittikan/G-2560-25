...
Level.prototype.create = function() {
	...
	this.map = this.game.add.tilemap("Lab7.5");
...
Level.prototype.addBoom = function(x, y){
...
Level.prototype.onCollide = function(){
	this.gameover =true;
	this.player.kill();
	this.dead.play();
	this.music.stop();
...
Level.prototype.onBoomCollide = function(){
...
Level.prototype.onCoinCollide = function(player, coin){
	coin.destroy();
	this.game.score++;
...
Level.prototype.onGoalCollide = function(player, goal){
	this.music.stop();
